...
from vllm.config.steer_vector import SteerVectorConfig, SteerVectorDType
...
class EngineArgs:
    ...
    steer_vector_dtype: torch.dtype | SteerVectorDType = (
        SteerVectorConfig.steer_vector_dtype
    )
